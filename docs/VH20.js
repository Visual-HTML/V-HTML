...
VH20.LoadDesignerCSS = function() {
	...
	_element.innerHTML += "@media screen and (min-width:360px) { body { background-color: red; padding-top: 200px; } } ";	
	_element.innerHTML += "@media screen and (min-width:480px) { body { background-color: green; padding-top: 100px; } } ";	
	_element.innerHTML += "@media screen and (min-width:767px) { body { background-color: blue; padding-top: 65px; } } ";	
