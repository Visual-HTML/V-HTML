...
VH20.LoadDesignerCSS = function() {
	...
	_element.innerHTML += "@media screen and (max-width:360px) { body { padding-top: 150px; } } ";	
	_element.innerHTML += "@media screen and (max-width:480px) { body { padding-top: 100px; } } ";	
	_element.innerHTML += "@media screen and (max-width:767px) { body { padding-top: 65px; } } ";	
