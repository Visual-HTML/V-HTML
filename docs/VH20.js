...
VH20.LoadDesignerCSS = function() {
	...
	_element.innerHTML += "@media screen and (min-width:210px) { body { background-color: red; padding-top: 100px; } } ";	
	_element.innerHTML += "@media screen and (min-width:360px) { body { background-color: green; padding-top: 75px; } } ";	
	_element.innerHTML += "@media screen and (min-width:480px) { body { background-color: blue; padding-top: 50px; } } ";		
	_element.innerHTML += "@media screen and (min-width:640px) { body { background-color: yellow; } } ";	
