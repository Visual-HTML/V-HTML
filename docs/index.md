...
This provide basic editor function, a preview, save as copy,it manage links (recognize them from plain text) and allow (if some securoty settings allow it) to add images...
